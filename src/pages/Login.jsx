...
const Login = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // You can dispatch login action here with user info from Google
        ...
        <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm">
              Don't have an account? <Link to="/signup" className="text-blue-600 hover:underline font-medium">Create an account</Link>
            </p>
          </div>
